...
没有用过 Skyline ，项目一旦有 Skyline 必报错。目前版本没有带 Server 所以报错，但不保证有了 Server 就会正常
...
其它请参考: [FAQ](https://github.com/msojocs/wechat-web-devtools-linux/blob/master/docs/FAQ.MD)
